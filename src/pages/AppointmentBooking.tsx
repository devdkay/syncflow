...
const features = [
  'Online booking calendar that syncs with your schedule',
  'Automatic email confirmations and reminders',
  'SMS reminders to reduce no-shows',
  'Payment collection at time of booking',
  'Rescheduling and cancellation options',
  'Multiple service types and time slots',
  'Staff scheduling for multiple team members',
...
const examples = [
  {
    ...
    description: 'Customers book haircuts, color services, and treatments online with specific stylists'
  },
  {
    title: 'Medical Practice',
    description: 'Patients schedule appointments, fill intake forms, and receive appointment reminders'
  },
  {
    title: 'Fitness Trainer',
    description: 'Clients book personal training sessions and group classes with payment upfront'
  },
  {
    title: 'Consulting Services',
    description: 'Prospects book free consultation calls and paid strategy sessions'
  }
];

export default function AppointmentBooking() {
  const navigateToContact = () => {
    window.location.href = '/contact?service=Automatic Appointment Booking';
  };
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-white relative">
      ...
      <section className="pt-24 pb-16 px-6 relative z-10">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Let customers book appointments directly from your website, anytime. We connect your calendar, send reminders, and handle payments automatically.
          </p>
          <button
      ...
      <section className="py-16 px-6 relative z-10">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-12 text-center">
            Booking System <span className="text-[#00D4FF]">Examples</span>
          </h2>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-[#00D4FF]/10 to-[#FF6B35]/10 relative z-10">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Stop playing phone tag. Let customers book appointments 24/7 while you focus on your business.
          </p>
          <button
            onClick={navigateToContact}
            className="neon-button"
